					...
					<div className="space-y-3 max-h-[calc(60vh-100px)] overflow-y-auto pr-1">
						...
						<div className="flex justify-between text-xs">
							...
							<span className="text-foreground/80">
								...
								{selectedLocation.dates.end && ` → ${selectedLocation.dates.end}`}
							</span>
						</div>
								...
								<div className="grid grid-cols-4 gap-1">
									{selectedLocation.photoUrls.slice(0, 4).map((url, index) => (
										...
										>
											...
											/>
											<div className="absolute top-0.5 left-0.5 w-4 h-4 bg-rose text-background text-[10px] font-bold rounded-full flex items-center justify-center">
												{index + 1}
											</div>
										</button>
									))}
										...
										{selectedLocation.photoUrls.map((url, index) => (
											...
											>
												<img
													...
													className="w-full h-full object-cover"
												/>
												<div className="absolute top-1 left-1 w-5 h-5 bg-rose text-background text-xs font-bold rounded-full flex items-center justify-center shadow">
													{index + 1}
												</div>
				...
				>
					...
					>
						...
						<img
							...
							className="max-w-full max-h-[80vh] object-contain rounded border border-border"
						/>
