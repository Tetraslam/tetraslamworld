...
export default function AdminPage() {
  ...
  const taste = useQuery(api.taste.list, {});
  ...
  const stats = [
    ...
    { label: "taste", count: taste?.length ?? 0, href: "/admin/taste" },
    {
      ...
      <div className="p-4 bg-surface border border-border rounded">
        ...
        {externalImages === undefined ? (
          ...
          <p className="text-sm text-green-500">
            all images are stored on Convex
          </p>
        ) : (
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              <p className="text-sm">
                ...
                external image{externalImages.length !== 1 ? "s" : ""} found
              </p>
              <button
                type="button"
